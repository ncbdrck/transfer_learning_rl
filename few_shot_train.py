...
import os
from configs.few_shot_arguments import get_args
from mpi4py import MPI
from agent.few_shot_td3 import Few_Shot_TD3_Agent
import random
import torch
...
def launch(args):
    ...
    # create the Few_Shot_TD3_Agent to interact with the environments
    meta_td3_trainer = Few_Shot_TD3_Agent(args, envs, env_params, env_names, seed)
    meta_td3_trainer.learn()
