...
import os
from configs.kl_combined_dynamic_multi_arguments import get_args
from mpi4py import MPI
from agent.kl_combined_dynamic_multi_td3 import TD3_Agent
import random
import torch
...
import panda_gym
"""
Multi-task Learning with TD3 - Dynamic task prioritization
"""
...
def launch(args):
    ...
    # env_names = ['FetchPush-v2', 'FetchPickAndPlace-v2', 'FetchSlide-v2']  # fetch environments (same action and obs space)
